...
public class DepotDispatchItemDto {
    ...
    public String getRmaNo() { return rmaNo; }
    public void setRmaNo(String rmaNo) { this.rmaNo = rmaNo; }
    public String getItemRmaNo() { return itemRmaNo; }
    public void setItemRmaNo(String itemRmaNo) { this.itemRmaNo = itemRmaNo; }
    ...
    public String getDepotStage() { return depotStage; }
    public void setDepotStage(String depotStage) { this.depotStage = depotStage; }
}
