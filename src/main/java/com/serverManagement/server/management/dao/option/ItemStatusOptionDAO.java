...
public interface ItemStatusOptionDAO extends JpaRepository<ItemStatusOptionEntity, Long> {
	...
	public boolean existsByItemStatusOptionValue(@Param("optionValue") String optionValue);
	...
	public ItemStatusOptionEntity getItemStatusOptionDetails(@Param("optionValue") String optionValue);
}
